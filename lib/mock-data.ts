...
import { getMayAnchorDate, getMayRelativeIso } from "@/lib/booking/may";

const venueNow = getMayAnchorDate();
...
export const bookableSlots: BookableSlot[] = [
  {
    ...
    courtId: "court-1",
    startsAt: getMayRelativeIso(1, "06:00"),
    endsAt: getMayRelativeIso(1, "07:00"),
    durationMinutes: 60,
    capacity: 4,
    priceInr: 700,
    paymentMode: "online",
  ...
  },
  {
    ...
    courtId: "court-3",
    startsAt: getMayRelativeIso(1, "18:00"),
    endsAt: getMayRelativeIso(1, "19:00"),
    durationMinutes: 60,
    capacity: 4,
    priceInr: 900,
    paymentMode: "hybrid",
  ...
  },
  {
    ...
    templateId: "template-prime",
    courtId: "court-4",
    startsAt: getMayRelativeIso(1, "19:00"),
    endsAt: getMayRelativeIso(1, "20:00"),
    durationMinutes: 60,
    capacity: 4,
    priceInr: 950,
    paymentMode: "hybrid",
  ...
  },
  {
    ...
    courtId: "court-5",
    startsAt: getMayRelativeIso(2, "07:00"),
    endsAt: getMayRelativeIso(2, "08:00"),
    durationMinutes: 60,
    capacity: 4,
    priceInr: 850,
    paymentMode: "pay_at_venue",
  ...
  },
  {
    ...
    templateId: "template-prime",
    courtId: "court-2",
    startsAt: getMayRelativeIso(2, "18:00"),
    endsAt: getMayRelativeIso(2, "19:00"),
    durationMinutes: 60,
    capacity: 4,
    priceInr: 900,
    paymentMode: "hybrid",
...
export const bookings: Booking[] = [
  {
    ...
    bookedAt: getMayRelativeIso(-2, "09:30"),
    status: "confirmed",
  ...
  },
  {
    ...
    bookedAt: getMayRelativeIso(-3, "11:00"),
    status: "confirmed",
  ...
  },
  {
    ...
    bookedAt: getMayRelativeIso(-4, "08:00"),
    status: "requested",
  ...
  },
  {
    ...
    bookedAt: getMayRelativeIso(-6, "08:00"),
    status: "completed",
    paymentStatus: "paid_online",
    attendees: 4,
  },
  {
    ...
    slotId: "slot-1",
    customerId: "customer-arav",
    bookedAt: getMayRelativeIso(-10, "08:00"),
    status: "completed",
    paymentStatus: "paid_online",
    attendees: 4,
  },
...
export const customerPacks: CustomerPack[] = [
  {
    ...
    creditsRemaining: 2,
    expiresAt: getMayRelativeIso(20, "23:59"),
  },
  {
    id: "customer-pack-2",
    customerId: "customer-meera",
    ...
    creditsRemaining: 1,
    expiresAt: getMayRelativeIso(5, "23:59"),
  },
];
...
export const customerMemberships: CustomerMembership[] = [
  {
    ...
    status: "active",
    renewsAt: getMayRelativeIso(14, "23:59"),
  },
  {
    ...
    status: "active",
    renewsAt: getMayRelativeIso(9, "23:59"),
  },
];
...
export const walletLedgerEntries: WalletLedgerEntry[] = [
  {
    id: "wallet-1",
    customerId: "customer-rhea",
    createdAt: getMayRelativeIso(-18, "09:00"),
    amountInr: 500,
  ...
  },
  {
    id: "wallet-2",
    customerId: "customer-rhea",
    createdAt: getMayRelativeIso(-10, "10:30"),
    amountInr: 200,
    kind: "promo_credit",
  ...
  },
  {
    id: "wallet-3",
    customerId: "customer-rhea",
    createdAt: getMayRelativeIso(-2, "09:30"),
    amountInr: -600,
    kind: "credit_spent",
  ...
  },
  {
    id: "wallet-4",
    customerId: "customer-meera",
    createdAt: getMayRelativeIso(-22, "10:30"),
    amountInr: 700,
    kind: "refund_credit",
...
export const offers: Offer[] = [
  ...
  },
  {
    ...
    status: "active",
    startsAt: getMayRelativeIso(-1, "00:00"),
    endsAt: getMayRelativeIso(23, "23:59"),
...
export const offerRedemptions: OfferRedemption[] = [
  {
    ...
    customerId: "customer-rhea",
    redeemedAt: getMayRelativeIso(-10, "10:00"),
    creditValueInr: 200,
  },
  {
    id: "redemption-2",
    offerId: "offer-sunrise",
    customerId: "customer-tara",
    redeemedAt: getMayRelativeIso(-4, "17:00"),
    creditValueInr: 200,
  },
];
...
export const attendanceEvents: AttendanceEvent[] = [
  {
    ...
    bookingId: "booking-5",
    customerId: "customer-kabir",
    attendedAt: getMayRelativeIso(-9, "19:10"),
  },
  {
    id: "attendance-2",
    bookingId: "booking-6",
    customerId: "customer-arav",
    attendedAt: getMayRelativeIso(-13, "06:58"),
  },
  {
    id: "attendance-3",
    bookingId: "booking-1",
    customerId: "customer-rhea",
    attendedAt: getMayRelativeIso(-16, "07:04"),
  },
];
...
export const customerNotes: CustomerNote[] = [
  {
    ...
    createdAt: getMayRelativeIso(-5, "11:30"),
